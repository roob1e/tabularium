...
import { Table, Button, Modal, Form, Input, message, Select, DatePicker, Space, theme } from "antd";
...
const StudentsTable: React.FC = () => {
    ...
    return (
        <div ref={containerRef} style={{ height: "100%", display: "flex", flexDirection: "column", padding: "10px" }}>
            ...
            <Table dataSource={students} columns={columns} rowKey="id" pagination={false} loading={loading} scroll={{ y: tableScrollY }} />
